...
- Sell, rent, lease, or sublicense the App to third parties
...
Sudoku Saga does not require you to create an account or provide personal information to use the App.

### 3.2 Local Data Storage

All game progress, statistics, and settings are stored locally on your device. We are not responsible for:
- Loss of data due to device failure, uninstallation, or factory reset
...
- Backing up your device if you wish to preserve game data
- Any activity that occurs on your device

## 4. In-App Purchases

### 4.1 Virtual Items

The App offers in-app purchases of virtual items, including but not limited to:
- Hint packs (consumable items)
- Other virtual goods as may be added

### 4.2 Payment Terms

- All purchases are processed through Google Play Billing or Apple App Store
- Prices are displayed in your local currency and include applicable taxes
- Payment will be charged to your Google Play or Apple account
- All sales are final unless otherwise required by law

### 4.3 Consumable Items

Hints and other consumable items:
- Are consumed upon use and cannot be refunded once used
...
Refunds for in-app purchases are handled by Google Play or Apple App Store according to their respective policies:
- **Google Play**: Refunds may be requested within the timeframe specified by Google Play's refund policy
- **Apple App Store**: Refunds may be requested through Apple's refund process

We do not have direct control over refunds processed by these platforms.

### 4.5 Price Changes

We reserve the right to modify prices for in-app purchases at any time. Price changes will not affect purchases already made.

## 5. Advertising (If Enabled)

### 5.1 Rewarded Ads

The App may offer optional rewarded video advertisements that provide in-game benefits (such as free hints) upon completion.
...
Watching advertisements is entirely optional. You are never required to watch ads to play the game.

## 6. Intellectual Property Rights

### 6.1 Our Ownership

The App and all its contents, features, and functionality (including but not limited to):
...
The Sudoku puzzles in the App are generated algorithmically. While individual puzzle solutions are not copyrightable, the collection, arrangement, and presentation of puzzles are our intellectual property.

### 6.3 Feedback

If you provide feedback, suggestions, or ideas about the App, you grant us a worldwide, perpetual, irrevocable, royalty-free license to use, modify, and incorporate such feedback without compensation or attribution.
...
You must NOT:
- Use cheats, exploits, automation software, bots, hacks, or mods
- Attempt to manipulate game statistics or leaderboards (if implemented)
- Interfere with or disrupt the App's functionality
- Engage in any fraudulent activity related to in-app purchases
...
- Removal of game progress and data
...
- Service interruption or device damage
- Any damages arising from your use or inability to use the App

OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID FOR IN-APP PURCHASES IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM, OR $50 USD, WHICHEVER IS GREATER.
...
We may release updates, patches, or new versions of the App. Updates may:
- Add, modify, or remove features
- Fix bugs and improve performance
- Change game mechanics or balance
...
- Provisions that should survive termination (including disclaimers, limitations of liability, and intellectual property rights) will continue to apply

## 12. Geographic Restrictions

The App is intended for use worldwide. However:
- We make no representation that the App is appropriate or available in all locations
- Accessing the App from territories where its content is illegal is prohibited
...
**Email**: hemaze.apps@gmail.com

**Developer**: Hemesh Animini  
**App Name**: Sudoku Saga : Multi Grid 
**Package Name**: com.hemaze.sudokusaga

## 16. Acknowledgment

BY USING SUDOKU SAGA, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE, UNDERSTAND THEM, AND AGREE TO BE BOUND BY THEM.
